# Distinct Polygon Soup validator (under construction)

A validator for entries to a [coding challenge on Code Golf Codidact](https://codegolf.codidact.com/posts/).

## :link: Webpage

[Access the validator directly](https://trichoplax.github.io/distinct-polygon-soup-validator/)
...
```bash
wasm-bindgen ./target/wasm32-unknown-unknown/release/distinct_polygon_soup_validator.wasm --out-dir web --no-typescript --target web
```
